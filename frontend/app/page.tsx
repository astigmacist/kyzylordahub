      ...
      <main>
        ...
        <section id="programs" className="py-16 px-6 bg-background transition-colors duration-300">
          <div className="max-w-[1440px] mx-auto">
            ...
            >
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">{t.programs.subtitle}</p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {t.programs.items.map((program, index) => {
                ...
                return (
                  ...
                  >
                    <Icon size={36} className="mb-4" style={{ color: programColors[index] }} />
        ...
        <section className="py-16 px-6 bg-background transition-colors duration-300">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <h2 className="text-4xl lg:text-5xl font-bold text-foreground mb-6">{t.cta.title}</h2>
              <p className="text-muted-foreground text-lg mb-8 max-w-2xl mx-auto">{t.cta.subtitle}</p>
              <motion.a
      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            ...
            whileHover={{ scale: 1.1, boxShadow: '0 0 30px rgba(45, 107, 255, 0.5)' }}
            whileTap={{ scale: 0.9 }}
            onClick={scrollToTop}

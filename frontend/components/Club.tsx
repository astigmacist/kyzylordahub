      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          <motion.a
            ...
            className="relative group p-8 bg-gradient-to-br from-[#25D366]/10 to-[#128C7E]/10 backdrop-blur-sm border border-[#25D366]/30 rounded-3xl overflow-hidden cursor-pointer"
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground">Присоединяйтесь к нашему сообществу в WhatsApp</p>
            </div>
          </motion.a>
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.03, y: -5 }}
            className="relative group p-8 bg-gradient-to-br from-[#0088cc]/10 to-[#0088cc]/5 backdrop-blur-sm border border-[#0088cc]/30 rounded-3xl overflow-hidden cursor-pointer"
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-16 h-16 bg-[#0088cc] rounded-2xl flex items-center justify-center">
                  <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-muted-foreground">Присоединяйтесь к нашему сообществу в Telegram</p>
            </div>
          </motion.a>
        </div>
        ...
        >
          <h2 className="text-4xl lg:text-5xl font-bold text-foreground mb-6">
            Наши <span className="bg-gradient-to-r from-[#2D6BFF] to-[#FF7A00] bg-clip-text text-transparent">клубы</span>
          </h2>
        </motion.div>
